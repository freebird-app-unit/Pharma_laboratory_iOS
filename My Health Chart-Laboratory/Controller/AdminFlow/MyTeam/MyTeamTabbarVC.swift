    ...
    static func instantiate() -> MyTeamTabbarVC {
        ...
        StoryBoardConstants.myTeam.instantiateViewController(
            withIdentifier: String(
                describing: MyTeamTabbarVC.self
            )
        ) as! MyTeamTabbarVC
    }
}
...
class MyTeamTabbarVC: UIViewController {
    ...
    private func setupTabbar() {
        ...
        let vc1 = MyTeamAllVC.instantiate()
        
        vc1.view.tag = 0
        
        let vc2 = MyTeamAdminsVC.instantiate()
        
        vc2.view.tag = 1
        
        let vc3 = MyTeamCollectorsVC.instantiate()
...
extension MyTeamTabbarVC:
    SwipableTabViewControllerDelegate,
    ToolBarDelegate {
