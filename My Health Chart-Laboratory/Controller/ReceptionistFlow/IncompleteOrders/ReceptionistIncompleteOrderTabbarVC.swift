//
//  ReceptionistInCompleteOrderTabbarVC.swift
...
extension ReceptionistIncompleteOrderTabbarVC {
    
    static func instantiate() -> ReceptionistIncompleteOrderTabbarVC {
        
        StoryBoardConstants.receptioninst.instantiateViewController(
            withIdentifier: String(
                describing: ReceptionistIncompleteOrderTabbarVC.self
            )
        ) as! ReceptionistIncompleteOrderTabbarVC
    }
}

class ReceptionistIncompleteOrderTabbarVC: UIViewController {
    ...
    private func setupTabbar() {
        ...
        let vc1 = ReceptionistIncompleteAllOrderVC.instantiate()
        
        vc1.view.tag = 0
        
        let vc2 = ReceptionistIncomleteRejectedOrderVC.instantiate()
        
        vc2.view.tag = 1
        
        let vc3 = ReceptionistIncompleteCancelledOrderVC.instantiate()
...
extension ReceptionistIncompleteOrderTabbarVC: SwipableTabViewControllerDelegate, ToolBarDelegate {
